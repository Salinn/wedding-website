...
export default {
  activities: [
    ...
    },
    {
      ...
      content:
        "Probably the most well known brewery in Boston and a great thing to check off your list of tihngs to do while you are here!",
      photo:
        "http://www.samueladams.com//app_media/SamAdamsRedux/Modules/Split-Content-Hero-Block-Images/Brewery-Image.file",
    ...
    },
    {
      ...
      content:
        "Looking to enjoy the wonderful weather and a beer? One of Paul's favorite spots to do both is the Trillium Beer Garden which is about a block away from work!",
      photo:
        "https://static1.squarespace.com/static/5527dc92e4b04be388ca48e4/t/5ae0a36baa4a99e2b64183b6/1524671343661/trillium_garden_glass-fence_web.jpg?format=2500w",
    ...
    },
    {
      ...
      content:
        "Two parks downtown right next to each other that are great to wander around in, enjoy the view and where Michelle and Paul got engaged!",
      photo:
        "https://cache-graphicslib.viator.com/graphicslib/page-images/360x240/100488_Boston_Boston%20Public%20Garden_d678-48.jpg",
      website:
        "https://www.viator.com/Boston-attractions/Boston-Public-Garden/d678-a1233",
      price: "Free"
    },
    {
  ...
  events: [
    {
      ...
      title: "Bridal Shower",
      content:
        "Ladies, please join us on  for Michelle’s Bridal Shower. Formal invitation with details to follow."
    },
    {
      id: 2,
      photo:
        "https://apis.xogrp.com/media-api/images/eb8af8fd-55fa-43a2-b5fd-52f8c02b8569~sc_768.576.fit?quality=60",
      ...
      title: "Rehearsal",
      content: "Please me us at Sacred Heart Chuch with Dinner to follow."
    },
    {
      id: 3,
    ...
    },
    {
      id: 4,
      photo:
        "http://dun6irwnoloqf.cloudfront.net/images/venues/9590/Hyatt-Regency-Boston-Harbor-wedding-Boston-MA-147503-orig.1484347437.jpg",
      date: "Saturday July 6th, 2019",
      time: "5:30 pm",
      location: {
  ...
  weddingParty: [
    ...
    },
    {
      ...
      type: "groomsMen",
      image:
        "https://s3.amazonaws.com/paulmichelle2019-website-photos/jaimeDarragh.png",
      name: "Jamie Darragh",
      bio:
        "Hi I am Jamie, I am Paul's younger brother. Some of my favorite memories with Paul are when we used to visit our grandparents for a week at a time in New Hampshire to ski in the winter and go swimming in the summer. One fun fact about me is that I got to travel all over the US as a truck driver with my trusted companion Luna."
    },
    {
      id: "14",
      type: "groomsMen",
      image:
        "https://s3.amazonaws.com/paulmichelle2019-website-photos/steveDenison.png",
      name: "Steven Denison",
      bio:
        "<img src='http://78.media.tumblr.com/tumblr_memiirCLKW1rek337o1_500.gif?fbclid=IwAR1WS8Y1-cyA1djsoAanpGQ319WqhyvRHDw7iPQ7E0A2hvRy7_3462SiMqA' /> <br /> Why? Because I am a god damn stallion!"
    }
  ],
  dashboard: {
  ...
  registeries: [
    ...
    },
    {
      name: "",
      photo:
        "https://d28m5bx785ox17.cloudfront.net/v1/img/-Y1JlqqN2s6M0FtcxkiWm5FGIMGKvqgkYKlnkHcW0zA=/d/l",
      url:
        "https://www.crateandbarrel.com/gift-registry/michelle-denison-and-paul-darragh/r5911703",
      alt: "Crate &amp; Barrel registry link"
    },
    {
      name: "Zola (Things not sold at Macy's or Crate & Barrel)",
      photo:
        "https://gulfbeachweddings.com/wp-content/uploads/2018/04/Zola-Logo.png",
  ...
  home: {
    hero: {
      url:
        "https://s3.amazonaws.com/paulmichelle2019-website-photos/hero-photo.jpg"
    },
    engagmentPhoto: {
      url:
        "https://s3.amazonaws.com/paulmichelle2019-website-photos/engagementPhoto.jpg"
    },
    howWeMet: {
